<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "INSERT INTO pediatrics(book_author, book_title, book_edition, year_published, publisher, quantity, availability, borrower) VALUES(:book_author, :book_title, :book_edition, :year_published, :publisher, :quantity, :availability, :borrower)";
...
<div class = "container">
	<a class = "btn btn-outline-primary" href="pedriatics_books_list.php" role="button">Medicine Books</a>
