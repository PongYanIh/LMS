<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "INSERT INTO histology(book_author, book_title, book_edition, year_published, publisher, quantity, availability, borrower) VALUES(:book_author, :book_title, :book_edition, :year_published, :publisher, :quantity, :availability, :borrower)";
...
<div class = "container">
	<a class = "btn btn-outline-primary" href="physiology_books_list.php" role="button">Histology Books</a>
