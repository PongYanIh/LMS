<html>
<head>
	<title> LABORATORY SCIENCE BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;">LABORATORY SCIENCE BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM lab_science";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" lab_medicine.php" role="button">Main Menu</a>
	<a class = "btn btn-outline-primary" href=" labscience_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "labscience_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "labscience_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
