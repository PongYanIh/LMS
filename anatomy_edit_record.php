<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "UPDATE anatomy SET book_author = :book_author, book_title = :book_title, book_edition = :book_edition, year_published = :year_published, publisher = :publisher, quantity = :quantity, availability = :availability, borrower = :borrower WHERE id = :id";
		}
		try {
			...
			if($result){
				echo "<script> alert('Record has been saved!'); window.location = 'anatomy_books_list.php'; </script>";
			}
...
<div class = "container">
<a class = "btn btn-outline-primary" href="anatomy_books_list.php" role="button">Anatomy Books</a>
<?php
	$sql = "SELECT * FROM anatomy WHERE id = :id";
