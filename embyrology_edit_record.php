<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "UPDATE embyrology SET book_author = :book_author, book_title = :book_title, book_edition = :book_edition, year_published = :year_published, publisher = :publisher, quantity = :quantity, availability = :availability, borrower = :borrower WHERE id = :id";
		}
		try {
...
<?php
	$sql = "SELECT * FROM embyrology WHERE id = :id";
