<html>
<head>
	<title> PARASITOLOGY & MICROBIOLIGY BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;">PARASITOLOGY & MICROBIOLIGY BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM parasitology";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" basic_medical.php" role="button">Main Menu</a>
	<a class = "btn btn-outline-primary" href=" parasitology_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "parasitology_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "parasitology_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
