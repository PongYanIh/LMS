...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" epidemiology_books_list.php" role="button">CLINICAL EPIDEMIOLOGY</a>
	<a class = "btn btn-outline-primary" href=" research_methodology_books_list.php" role="button">RESEARCH METHODOLOGY</a>
	<a class = "btn btn-outline-primary" href=" biostatistics_books_list.php" role="button">BIOSTATISTICS</a>
	</div>
