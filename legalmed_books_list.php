<html>
<head>
	<title> LEGAL MEDICINE BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;"> LEGAL MEDICINE BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM legal_medicine";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" legalmed_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "legalmed_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "legalmed_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
