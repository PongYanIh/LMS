<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "INSERT INTO medical_journals(category, book_author, book_title, book_edition, year_published, publisher, quantity, availability, borrower) VALUES(:category, :book_author, :book_title, :book_edition, :year_published, :publisher, :quantity, :availability, :borrower)";
		...
		try {
			...
			if($result){
				echo "<script> alert('Record has been saved!'); window.location = 'medical_journals.php'; </script>";
			}
...
<div class = "container">
	<a class = "btn btn-outline-primary" href="medical_journals.php" role="button">MEDICAL JOURNALS</a>
