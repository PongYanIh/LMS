...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" legalmed_books_list.php" role="button">LEGAL MEDICINE</a>
	<a class = "btn btn-outline-primary" href=" medjurisprudence_books_list.php" role="button">MEDICAL JURISPRUDENCE</a>
	<a class = "btn btn-outline-primary" href=" bioethics_books_list.php" role="button">MEDICAL/BIOETHICS</a>
	</div>
