<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "UPDATE nutrition SET book_author = :book_author, book_title = :book_title, book_edition = :book_edition, year_published = :year_published, publisher = :publisher, quantity = :quantity, availability = :availability, borrower = :borrower WHERE id = :id";
		}
		try {
			...
			if($result){
				echo "<script> alert('Record has been saved!'); window.location = 'nutrition_books_list.php'; </script>";
			}
...
<div class = "container">
<a class = "btn btn-outline-primary" href="nutrition_books_list.php" role="button">Nutrition Books</a>
<?php
