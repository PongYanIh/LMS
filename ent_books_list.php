<html>
<head>
	<title> ENT, OPHTHALMOLOGY & OTORHINOLARYNGOLOGY BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;">MEDICINE BOOKS</h1>
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" ent_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "	ent_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "ent_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
