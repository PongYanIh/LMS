<html>
<head>
	<title> BIOCHEMISTRY BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;">BIOCHEMISTRY BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM biochemistry";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" biochemistry_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "biochemistry_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "biochemistry_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
