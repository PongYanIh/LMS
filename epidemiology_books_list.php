<html>
<head>
	<title> EPIDEMIOLOGY BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;"> EPIDEMIOLOGY BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM clinical_epidemiology";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" medical_research.php" role="button">Main Menu</a>
	<a class = "btn btn-outline-primary" href=" epidemiology_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "epidemiology_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "epidemiology_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
