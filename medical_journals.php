<html>
<head>
	<title> MEDICAL JOURNAL BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;"> MEDICAL JOURNAL BOOKS BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM medical_journals";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" medical_journals_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "medical_journals_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "medical_journals_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
