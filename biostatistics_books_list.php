<html>
<head>
	<title> BIOSTATISTICS BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;"> BIOSTATISTICS BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM biostatistics";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" biostatistics_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "biostatistics_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "biostatistics_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
