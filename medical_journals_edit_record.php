<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "UPDATE medical_journals SET category = :category, book_author = :book_author, book_title = :book_title, book_edition = :book_edition, year_published = :year_published, publisher = :publisher, quantity = :quantity, availability = :availability, borrower = :borrower WHERE id = :id";
		}
		try {
...
<div class = "container">
<a class = "btn btn-outline-primary" href="medical_journals.php" role="button">MEDICAL JORUNALS</a>
<?php
	$sql = "SELECT * FROM medical_journals WHERE id = :id";
