<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "INSERT INTO pharmacology(book_author, book_title, book_edition, year_published, publisher, quantity, availability, borrower) VALUES(:book_author, :book_title, :book_edition, :year_published, :publisher, :quantity, :availability, :borrower)";
		...
		try {
			...
			if($result){
				echo "<script> alert('Record has been saved!'); window.location = 'pharmacology_books_list.php'; </script>";
			}
...
<div class = "container">
	<a class = "btn btn-outline-primary" href="pharmacology_books_list.php" role="button">Pharmacology Books</a>
