<html>
<head>
	<title> NEUROANATOMY BOOKS</title>
...
<br>
<br>
<h1 style="text-align:center;">NEUROANATOMY BOOKS</h1>

<?php

require("db_connect.php");

$sql = "SELECT * FROM neuroanatomy";
...
<div class = "container">
	...
	<a class = "btn btn-outline-primary" href=" neuroanatomy_add_record.php" role="button"> Add Record</a> 
	<br>
	<br>
...
?>                <tr>
					...
					<td>
						<a href = "neuroanatomy_edit_record.php?id=<?php echo $row["id"]?>" class = "btn btn-warning">Edit Record</a>
					</td>
					<td>
						<a href = "neuroanatomy_delete_record.php?id=<?php echo $row["id"]?>" class = "btn btn-danger">Delete Record</a>
					</td>
                </tr>
<?php
            }
