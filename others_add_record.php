<?php
	...
	if(isset($_POST["book_author"])){
		...
		$sql = "INSERT INTO others(category, book_author, book_title, book_edition, year_published, publisher, quantity, availability, borrower) VALUES(:category, :book_author, :book_title, :book_edition, :year_published, :publisher, :quantity, :availability, :borrower)";
...
<div class = "container">
	<a class = "btn btn-outline-primary" href="onco_neo_medicine.php" role="button">UNCATEGORIZES BOOKS</a>
